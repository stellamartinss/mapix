export default {
  // Header
  appName: 'Mapin',
  tagline: 'Find where the Street View is',
  roundsRemaining: 'rounds remaining',

  // Buttons
  startGame: 'Start Game',
  playAgain: 'Play Again',
  confirmGuess: "It's here!",
  ...
  veryGoodShort: 'Very good',
  goodShort: 'Good',
  fairShort: 'Fair',
  weakShort: 'Weak',
  veryFarShort: 'Very far',
  ...
  onboarding10: 'Every detail matters.',
  onboarding11: 'Mark the location.',
