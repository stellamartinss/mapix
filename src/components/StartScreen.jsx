  ...
  return (
    <div className="min-h-[400px] grid place-items-center py-12 px-6">
      <div className="max-w-[600px] text-center flex flex-col gap-6">
        ...
        <h2 className="m-0 text-2xl md:text-3xl text-slate-900 dark:text-slate-100">{t('welcomeTitle')}</h2>
          ...
          <>
            {attemptsLeft !== null && (
              <div className="py-3 px-5 bg-slate-100 dark:bg-slate-800 rounded-xl text-sm text-slate-600 dark:text-slate-400">
                <span>{t('attemptsRemaining')}: <strong className="text-slate-900 dark:text-slate-100 font-bold">{attemptsLeft}</strong></span>
              </div>
            )}
        ...
        <div className="mt-6 p-6 bg-slate-50 dark:bg-slate-800 rounded-xl text-left md:p-8">
          <h3 className="m-0 mb-4 text-lg text-slate-900 dark:text-slate-100 text-center">{t('howToPlay')}:</h3>
