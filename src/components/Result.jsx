...
function Result({
  ...
  return (
    <div className='grid grid-cols-[1fr_auto] md:grid-cols-[auto_1fr_auto] gap-3 items-center w-full md:w-[500px]'>
      {distanceKm === null ? (
        <button
          type='button'
          onClick={onConfirm}
      ...
      {/* botão hide pequeno e à direita */}
      <button
        type='button'
        onClick={() => onHideToggle()}
        className='ml-auto px-2 py-1 text-xs rounded-md bg-slate-200 hover:bg-slate-300 
